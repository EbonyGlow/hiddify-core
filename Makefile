...
android: lib_install
	gomobile bind -v -androidapi=21 -javapkg=io.nekohasekai -libname=box -tags=$(TAGS) -trimpath -target=android -ldflags="-w -s -linkmode external -extldflags='-Wl,-z,common-page-size=4096 -Wl,-z,max-page-size=16384'" -o $(BINDIR)/$(LIBNAME).aar github.com/sagernet/sing-box/experimental/libbox ./mobile
