...
android: lib_install
	...
	gomobile bind -v -androidapi=21 -javapkg=io.nekohasekai -libname=box -tags=$(TAGS) -trimpath -target=android/arm64 -ldflags='-w -s -extldflags=-Wl,-z,max-page-size=16384' -o $(BINDIR)/$(LIBNAME).aar github.com/sagernet/sing-box/experimental/libbox ./mobile
